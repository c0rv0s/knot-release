...
//  Knot
//
//  Created by Nathan Mueller on 2/13/16.
...
//table for favorited listings

class savedListings: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
*/
    ...
    override func prepareForSegue(segue: UIStoryboardSegue?, sender: AnyObject?) {
        ...
        if (segue!.identifier == "SavedDetailSeg") {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        self.performSegueWithIdentifier("SavedDetailSeg", sender: tableView)
